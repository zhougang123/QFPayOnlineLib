...
@property (nonatomic, copy  ) NSString *cardcd;
@property (nonatomic, copy  ) NSString *chnlsn;
@property (nonatomic, copy  ) NSString *chnltm;
@property (nonatomic, copy  ) NSString *chnluserid;
@property (nonatomic, copy  ) NSString *contact;
@property (nonatomic, copy  ) NSString *incardnm;
@property (nonatomic, copy  ) NSString *issuerbank;
@property (nonatomic, copy  ) NSString *latitude;
@property (nonatomic, copy  ) NSString *longitude;
@property (nonatomic, copy  ) NSString *outcardnm;
@property (nonatomic, copy  ) NSString *resperr;
@property (nonatomic, copy  ) NSString *respcd;
@property (nonatomic, copy  ) NSString *riskret;
 ...
 ***@qrQRCode 扫描获取到的二维码
 ***/
- (void)WXPaySiwpeWihtAmount:(NSString *)amount
...
- (void)WXPayCloseOrderWithAmount:(NSString *)amount
                            syssn:(NSString *)syssn
                          success:(void (^)(QFOrderInfo *orderIno))successBlock
                           failed:(void (^)(QFOrderInfo *orderIno, NSString *errorMsg))failedBlock;
/***
 ***微信退款,需要验证密码
...
- (void)WXPayRefundWithAuthPassword:(NSString *)password
                       ...
                       originBusicd:(NSString *)busicd              //
                     originClientSN:(NSString *)originCliSN         //
                        originSyssn:(NSString *)originSyssn         //
                   originClientTime:(NSString *)originclientTime
                            success:(void (^)(QFOrderInfo *orderIno))successBlock
                             failed:(void (^)(QFOrderInfo *orderIno, NSString *errorMsg))failedBlock;
...
- (void)AliPayCloseOrderWithAmount:(NSString *)amount
                      originBusicd:(NSString *)busicd              //
                    originClientSN:(NSString *)originCliSN         //
                       originSyssn:(NSString *)originSyssn         //
                  originClientTime:(NSString *)originclientTime
